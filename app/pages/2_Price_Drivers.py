...
from app.styles import inject_custom_css, apply_chart_style, BLUE, BLUE_DARK, RED, CARD_BG
...
with tab_corr:
    ...
    fig = px.imshow(
        corr,
        text_auto=".2f",
        color_continuous_scale=[[0, RED], [0.5, CARD_BG], [1, BLUE]],
        zmin=-1,
        zmax=1,
    )
    apply_chart_style(fig)
